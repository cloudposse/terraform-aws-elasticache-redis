...
| snapshot_window              | Window for snapshots (hh24:mm-hh24mm)  | string | `` | no |
| snapshot_name                | Name of the snapshot                   | string | `` | no |
| snapshot_retention_limit     | Number of snapshots to retain          | number | `0` | no |
| snapshot_arns                | ARN of the snapshots                   | list | `<list>` | no |
